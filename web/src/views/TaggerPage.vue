...
import {
  ...
  downloadMultipleFilesAsZip, selectTrainImg, getDataInDBByKey, emitter,
} from "../main.ts";
    ...
    <div class="col-4">
      <div class="py-3">
        ...
        <div class="gap-2"
          ...
          <span v-for="tag in selectTrainImg?.tags" :key="tag"
            ...
            <a @click="deleteSelectTag(tag)">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                   class="bi bi-x-circle-fill" :class="tag" viewBox="0 0 16 16">
                <path
      ...
      <div class="py-3">
        ...
        <div class="gap-2"
          ...
          <span v-for="tag in tagRecommend" :key="tag"
                class="badge d-flex p-2 align-items-center rounded-pill border bg-primary"
